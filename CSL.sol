...
contract TimeLockable is Administratable{
    ...
    function timeLockPE(address _target) public onlySuperAdmins validateAddress(_target) {
        require(timelockedAccounts[_target] == 0);
        timelockedAccounts[_target] = PE_LOCKUP_END;
        emit LockedFunds(_target, PE_LOCKUP_END);
    }
}
...
contract Coinslot is ERC20Burnable, TimeLockable, Freezable
{
    string  public  constant name       = "Coinslot";
